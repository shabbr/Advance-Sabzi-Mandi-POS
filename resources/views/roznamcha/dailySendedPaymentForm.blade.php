...
<h3>Daily Sended Payment</h3>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="p-4 rounded bg-light h-100">
                            ...
                            <form action="{{ 'addDailySendedPayment' }}" method="post" class="row g-3">
                                @csrf
                                <div class="col-12">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="{{route('removeSendedAmount',['id'=>$expense->id])}}" class="btn btn-danger ">Remove</a> </td>
                                        </tr>
                                        @endforeach
                                        @endisset
                                    </tbody>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-12 col-xl-12">
                                <div class="p-4 rounded bg-light h-100">
                                    ...
                                    <form action="{{ 'sendedAmount' }}" method="post" class="row g-3">
                                        @csrf
                                        <div class="col-12">
                                            <div class="mb-4 d-flex justify-content-between align-items-center">
                                                {{-- Your heading or other content --}}
