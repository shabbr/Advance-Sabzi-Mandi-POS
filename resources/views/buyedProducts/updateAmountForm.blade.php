...
<div class="content">
    <!-- Form Start -->
        ...
        <form action="{{ route('updatePaymentSender') }}" method="post" class="mt-5 row g-3">
            @csrf
            <div class="col-12 col-sm-6 col-xl-12 col-md-12">
                <div class="p-4 rounded bg-light">
                    ...
                    <div class="mb-3 form-floating">
                        <input type="number" name="sended_payment" value="{{$sended_payment}}" class="form-control" disabled id="floatingInput" placeholder="Quantity">
                        <label for="floatingInput">Sended Payment</label>
                    </div>
                    <div class="mb-3 form-floating">
