                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="p-4 rounded bg-light h-100">
                            <h5 class="mb-4 ">New Sender</h5>

                            <form action="{{ route('addSeller') }}" method="post" class="row g-3">
                                @csrf
                                <div class="col-12 col-md-12">
                                    <div class="p-4 rounded bg-light">
                                        ...
                                        <div class="mb-3 form-floating">
                                            <input type="text" name="account" value="{{old('account')}}" class="form-control" id="floatingPassword" placeholder="account">
                                            <label for="floatingPassword">Account No</label>
                                            @error('account')
                                            <div class="text-danger"> {{$message}} </div>
                                            @enderror
                                        </div>
