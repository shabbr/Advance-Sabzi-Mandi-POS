                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="p-4 rounded bg-light h-100">
                            ...
                            <form action="{{route('updateTodayPayment')}} " method="post" class="row g-3">
                                @csrf
                               ...
                               <div class="mb-3 form-floating">
                                            <input type="number"  disabled required value="{{$recieved_payment}}" class="form-control" id="floatingInput" placeholder="Price of one Item">
                                        ...
                                        <div class="mb-3 form-floating">
                                            <input type="number" name="recieved_payment" required class="form-control" id="floatingInput" placeholder="Received Payment">
