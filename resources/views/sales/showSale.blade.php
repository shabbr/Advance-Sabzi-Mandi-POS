                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="p-4 rounded bg-light h-100 ">
                                <div class="mb-4 d-flex justify-content-between align-items-center">
                                    <h5 class="mb-0">Sales of Today</h5>
...
@endphp
                               ...
                               @endforeach
                                ...
                                <td > <a href="{{route('addPaymentForm',['customerId'=>$sale->customer_id,'gd'=>$sale->total_price])}}"  class="btn btn-success bg-success">Payment</a> </td>
